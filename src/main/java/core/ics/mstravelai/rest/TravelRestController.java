...
public class TravelRestController {
    ...
    public ResponseEntity<String> teste(@RequestParam String value){
        OpenAiService service = new OpenAiService(SetupConfig.OPENAI_API_KEY);
        ...
        return ResponseEntity.status(HttpStatus.OK).body(service.createCompletion(request).getChoices().toString());
    }
